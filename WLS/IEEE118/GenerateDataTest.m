...
% %%%%%%%%%%%%%%%%%True Measurements%%%%%%%%%%%%%%%%%
ratio = xlsread('loadprofile-test', 'Sheet1');
[r,c] = size(ratio);
...
while row <= r
    ...
    %     [baseMVA, bus, gen, branch, success, et] = runopf(mpc);
...
xlswrite('truetestdata.xlsx',measurements, 'Sheet1');
xlswrite('trueteststate.xlsx',true_values,'Sheet1');
...
xlswrite('actualtestdata.xlsx',tt,'Sheet1');
end